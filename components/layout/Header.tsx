...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex flex-col items-center pointer-events-none">
      ...
      <div
        className={`pointer-events-auto mt-3 md:mt-4 w-[95%] max-w-5xl transition-all duration-300 rounded-2xl ${
          scrolled
      ...
      >
        <div className="px-6 h-12 md:h-14 flex items-center justify-between gap-6">
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="pointer-events-auto md:hidden overflow-hidden mt-2 w-[95%] max-w-5xl rounded-2xl border border-border bg-bg-primary/90 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)]"
          >
